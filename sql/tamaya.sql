...
values("ビッグ線香花火",98,9,"日本製の線香花火です。線香花火シリーズの中で最大サイズになります。長い時間楽しみたい方、面白い花火が好きな方にお勧めの花火となっております。",2,"./img/test01_.jpg")
...
,("打ち上げフラッシュモブ花火",2560,25,"タイ製の打上げ花火です。タイでは国内売上生産第一位の人気製品となります",1,"./img/flashmob.jpg")
,("サッカー花火",4444,10,"イタリア製の打上げ花火です。サッカー観戦をしながら楽しめる花火となっております",2,"./img/soccer.jpg")
,("するめ花火",450,5,"食べれる花火です。お酒のつまみにも。",2,"./img/surume.jpg")
