...
values('純国産線香花火',98,9,'100％日本製の線香花火です。線香花火シリーズの中でも大き目のサイズになります。長い時間楽しみたい方、日本の職人が作った花火を楽しみたいお客様にお勧めの花火となっております。','temoti','./img/big_senkou.jpg')
,('ロケット花火',78,5,'日本製のロケット花火です。ロケット花火シリーズの中で最小サイズになります。大きい花火が苦手な方、面白い花火が好きな方にお勧めの花火となっております。','utiage','./img/rocket.jpg')
,('家庭用打上げ花火',586,7,'日本製の打上げ花火です。打上げ花火シリーズの中でも珍しい家庭用になります。家で花火を楽しみたい方、雨の日でも花火を楽しみたい方にお勧めとなっております。','utiage','./img/katei_uchiage.jpg')
...
,('メガトンバッグ',13000,7,'５１Lの最大級花火をご用意いたしました。厳選した１４４本の花火をお楽しみください。','sonota','./img/megaton_bag.jpg')
...
,('黄金極太スパーク（３P）',500,12,'金色の光が力強く降り注ぎ、いくつもの火花が舞い散ります。持続時間も３０秒と長く、満足して頂ける一品です。','temoti','./img/gold_spark.jpg')
,('メタリックカラースパーク',700,7,'黄・赤・緑色の三色の花火をご用意いたしました。激しい火花がスパークします。','temoti','./img/color_spark.jpg')
