...
<body>
	...
	<p style="color: #FF55FF">花火の特集ページです。</p>
	<h2 style="color: #668ad8">家族用</h2>
	<h3 style="color: #00FF00">黄金極太スパーク</h3>
	...
	<h4 style="color:red;">お客様の声</h4>
	<p>子供と一緒に楽しみました。</p>
	<p>すぐに終わらないので子供も喜んでいました。</p>

	<h3 style="color: #00FF00">パワフル三変化(5本入)</h3>
	...
	<h3 style="color: #00FF00">バリバリ3変色すすき(５本入)</h3>
	...
	<h2 style="color: #668ad8">カップル用</h2>
	<div class="box">
		<h3 style="color: #00FF00">花花 はなはな</h3>
		...
		<h3 style="color: #00FF00">煌(きらめき)牡丹花(３０本入)</h3>
		...
		<h3 style="color: #00FF00">袋入りおみくじ花火(４本入)</h3>
		...
		<h2 style="color: #668ad8">大人数用</h2>
	</div>
	<div class="box">
		<h3 style="color: #00FF00">メガトンバッグ</h3>
		...
		<h3 style="color: #00FF00">がんばろう日本</h3>
