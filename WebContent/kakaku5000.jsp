...
<link rel="stylesheet" type="text/css" href="./css/kakaku0000.css" media="all">
  ...
  <body>
    <div id="header"></div>
    <ul class="nav">
    <li class="nav__item1"><a href="kakaku0000.jsp">5000円～</a></li>
    <li class="nav__item"><a href="kakaku0500.jsp">～499円</a></li>
    <li class="nav__item"><a href="kakaku1000.jsp">500円～999円</a></li>
    <li class="nav__item"><a href="kakaku5000.jsp">1000円～4999円</a></li>
	</ul>
