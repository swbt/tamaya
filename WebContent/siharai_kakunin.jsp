...
<!DOCTYPE html>
    ...
    <tbody>
    <tr>
    <td>氏名</td><td align="center"><s:property value="userName" /></td>
    </tr>
    <tr>
    <td>お届け先住所</td><td align="center"><s:property value="userAddress" /></td>
    </tr>
    </tbody>
    </table>

	<div>
    <a href="./siharai_kanryo.jsp"> <s:form action="FinalizePurchaseOrderAction"></s:form>
