	...
	<table>
		...
		<s:iterator value="creditList">
			<tbody>
				...
				<tr>
					<td>有効期限</td>
					<td align="center"><s:property value="expirationYear" />
						<s:property value="expirationMonth" /></td>
				</tr>
				<tr>
					<td>カード名義人</td>
...
<div class="center">
	...
	<div>
		<a href="./siharai_kanryo.jsp"> <s:form
				action="FinalizePurchaseOrderAction"></s:form> <img
